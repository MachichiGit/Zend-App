...
return [
        ...
        'routes' => [
            ...
            'urls' => [
                ...
                'options' => [
                    'route'    => '/urls',
                    'defaults' => [
                        'controller' => Controller\URLsController::class,
                        'action'     => 'index',
                    ],
                ],
                'may_terminate' => true,
    ...
    'controllers' => [
        'factories' => [
            ...
            Controller\URLsController::class => InvokableFactory::class,
            Controller\WebsiteController::class =>  Controller\Factory\WebsiteControllerFactory::class,
            Controller\URLsController::class =>  Controller\Factory\URLsControllerFactory::class,
